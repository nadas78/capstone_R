...
The example is inspired by a classical test data set [@Student1908] about a study with two groups of persons treated with two different pharmaceutical drugs.
